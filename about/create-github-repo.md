...
2. Select the **Create New > New repository** menu item (upper right)
   ...
   ![](images/create-github-repo-create-new-repository.png)
...
3. Enter parameters as follows
   ...
   | Choose visibility | Public                                                       | This means that  anyone on the Internet can see the repo (but you can still choose who can  commit to it.     Private is an option but it prevents us from configuring the repo the way we need (the [Configure GitHub Pages](configure-github-pages.md) procedure explains why). |
   ...
   ![](images/create-github-repo-new-repo-form.png)
